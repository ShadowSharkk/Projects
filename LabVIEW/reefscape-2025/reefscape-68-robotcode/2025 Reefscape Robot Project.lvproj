...
AddOutputFilter chunkFilter
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="Rotate Polygon.vi" Type="VI" URL="../../bordeaux-pathinator/Bordeaux/Trajectory/Clothoid/Rotate Polygon.vi"/>
			<Item Name="BotPose Correction.vi" Type="VI" URL="../../../../2025-robot-template (BotPose Auto Correction)/Robot Code/Drive/Commands/BotPose Correction.vi"/>
			<Item Name="Bordeaux to Botpose Convert Coordinates.vi" Type="VI" URL="../../../../2025-robot-template (BotPose Auto Correction)/Robot Code/Drive/Commands/Bordeaux to Botpose Convert Coordinates.vi"/>
		</Item>
		<Item Name="Build Specifications" Type="Build">
